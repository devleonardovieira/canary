local mType = Game.createMonsterType("Shino")
local monster = {}

monster.description = "Shino"
monster.experience = 30495
monster.outfit = {
	lookType = 8,
	lookHead = 87,
	lookBody = 0,
...
monster.attacks = {
	...
	{ name = "poison", interval = 1000, chance = 52, minDamage = -150, maxDamage = -300 },
}
