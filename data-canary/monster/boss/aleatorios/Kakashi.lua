local mType = Game.createMonsterType("Kakashi")
local monster = {}

monster.description = "Kakashi"
monster.experience = 33312
monster.outfit = {
	lookType = 343,
	lookHead = 76,
	lookBody = 76,
...
monster.health = 57200
monster.maxHealth = 57200
monster.race = "blood"
