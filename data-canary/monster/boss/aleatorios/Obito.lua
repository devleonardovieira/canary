local mType = Game.createMonsterType("Obito")
local monster = {}

monster.description = "Obito"
monster.experience = 216238
monster.outfit = {
	lookType = 743,
	lookHead = 77,
	lookBody = 76,
...
monster.health = 520000
monster.maxHealth = 520000
monster.race = "blood"
