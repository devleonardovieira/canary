local mType = Game.createMonsterType("Tenten")
local monster = {}

monster.description = "Tenten"
monster.experience = 31327
monster.outfit = {
	lookType = 199,
	lookHead = 20,
	lookBody = 34,
...
monster.attacks = {
	...
	{ name = "jogarshuriken", interval = 1000, chance = 100, minDamage = -50, maxDamage = -150 },
}
